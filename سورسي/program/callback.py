...
async def cbstart(_, query: CallbackQuery):
    await query.answer("الصفحة الرئيسية")
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوتك›", url=f"https://t.me/B_4_M"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def cbguides(_, query: CallbackQuery):
 ...
 4 ↤ أضف @{mybetr} إلى مجموعتك أو اكتب انضم لدعوة حساب المساعد
 ...
 💡 إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا منن خلال قروب الدعم الخاصة بي هنا ↤ @{KCIIA}
...
async def cbbasic(_, query: CallbackQuery):
    await query.answer("الاوامر الاساسية")
    await query.edit_message_text(
        f"""❤️‍🔥 الاوامر الاساسيه:
...
async def cbadmin(_, query: CallbackQuery):
    await query.answer("اوامر الادمنية")
    await query.edit_message_text(
        f"""❤️‍🔥 هنا أوامر الادمنية:
