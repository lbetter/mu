...
💭 **᥀︙انا بوت بيتراستطيع تشغيل الاغاني والموسيقى في المكالمات  الصوتية! 
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("❤️‍🔥 المطور", url=f"https://t.me/{B_4_M}"),
                ],
                [
                    InlineKeyboardButton(
                        "‹ قروب الدعم › ", url=f"https://t.me/{KCIIA}"
                    ),
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/B_4_M"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/259fde5ac3151e0c2ebe9.jpg",
        caption=f"""Programmer [ހވޱ.𓅗🇦🇪](https://t.me/B_4_M) ♡︎\مبرمج السورس """,
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("ހވޱ.𓅗🇦🇪", url=f"https://t.me/B_4_M"),
            ],
            [
                InlineKeyboardButton(
                    "¹ހވޱ.𓅗🇦🇪 .", url=f"https://t.me/B_5_M"
                ),
            ],
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"{DEV_PHOTO}",
        caption=f"""♡︎ الاول : هو مطور السورس \n♡︎ الثاني : هو مطور البوت\n√""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("ހވޱ.𓅗🇦🇪 ", url=f"https://t.me/B_4_M"),
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("‹ قناة البوت ›", url=f"https://t.me/{ZZ9ZQ}"),
                            InlineKeyboardButton("‹ قروب الدعم ›", url=f"https://t.me/{KCIIA}")
                        ],
                        [
                            InlineKeyboardButton(
